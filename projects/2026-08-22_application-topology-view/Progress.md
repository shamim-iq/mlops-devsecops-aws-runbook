...
`active` - 2026-08-22. The topology requirement is captured as a separate project, and Markdown with Mermaid is selected as the first output format. No code, RBAC, generated topology report, or CLI exists yet.
